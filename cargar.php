...
$data_points[0] = array("fecha","temperatura");
 $SQLDatos = "SELECT `temperatura`,`fecha` FROM `datos` WHERE `serie` = '1.0'  AND  `fecha` BETWEEN '$fecha1' AND '$fecha2'ORDER BY fecha ASC";
   ...
   echo json_encode($data_points);
 ...
 
    {
         $data_points[0] = array("fecha","humedad");
          $SQLDatos = "SELECT `humedad`,`fecha` FROM `datos` WHERE `serie` = '1'  AND  `fecha` BETWEEN '$fecha1' AND '$fecha2'ORDER BY fecha ASC";
   ...
   echo json_encode($data_points);
 ...
 
    {
         $data_points[0] = array("fecha","precipitacion");
          $SQLDatos = "SELECT `precipitacion`,`fecha` FROM `datos` WHERE `serie` = '1'  AND  `fecha` BETWEEN '$fecha1' AND '$fecha2'ORDER BY fecha ASC";
   ...
   echo json_encode($data_points);
 ...
 
    {
         $data_points[0] = array("fecha","velocidad_del_viento");
          $SQLDatos = "SELECT `velocidad_del_viento`,`fecha` FROM `datos` WHERE `serie` = '1'  AND  `fecha` BETWEEN '$fecha1' AND '$fecha2'ORDER BY fecha ASC";
