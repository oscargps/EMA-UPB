...
<?php
   ...
   if ($estado!="todo")
   {
     ...
     $query = "SELECT * FROM datos WHERE serie=1 AND fecha BETWEEN'$_POST[fecha1]' AND '$_POST[fecha2]'order by id DESC";
...
<?php 
   ...
   if($fecha1=="")
   {
     $query = "SELECT temperatura, humedad, velocidad_del_viento,direccion_del_viento,precipitacion,fecha FROM datos WHERE serie=1 order by id DESC";
   }else
   {
   $query = "SELECT temperatura, humedad, velocidad_del_viento,direccion_del_viento,precipitacion,fecha FROM datos  WHERE serie=1 AND fecha BETWEEN '$_POST[fecha1]' AND '$_POST[fecha2]' order by id DESC";
   }
   $result = mysqli_query($con,$query);
   $numero = 0;
